...
export const FeedbackDataMain = [
  ...
  },
  {
    ...
    date: '12.10.2022',
    feedback:
      'Ребята из Digital Buro помогли упаковать идею в конечный продукт. Они оказывали профессиональную помощь на всех этапах и были нацелены на результат!',
  },
  {
    id: 5,
    name: 'Константин',
