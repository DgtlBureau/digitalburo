...
![Страны, где начал активно развиваться падел-теннис](https://imgur.com/26gGvqm)
...
![Игра в падел](https://imgur.com/4kQb3Ve)
...
![Рост кортов для падел-тенниса с 2016-го по 2023 годы](https://imgur.com/GWVWpuG)
...
![ Рост количества клубов падел-тенниса](https://imgur.com/6KWzAKj)
...
В мире падел пока тоже только развивается. Он ещё не бешено популярен в США, Великобритании, Франции и Германии. Но это вопрос времени. Ожидается, что к 2026 году на планете будет более **85 тыс.** кортов для игры в _Padel_. Вокруг падела уже строится масштабная экосистема, стоимость которой пока оценивается в **2 млрд евро**, и она очень быстро растёт.
...
![Корт для падел-тенниса](https://imgur.com/Uc8T2NA)
...
![Мяч может отскочить от корта при игре в падел только один раз](https://imgur.com/3DOtWXm)
...
![Ракетка для падел-тенниса](https://imgur.com/NdKFdkg)
...
![Мяч для падел-тенниса](https://imgur.com/72cnsXm)
...
- **Аренда корта** — около _3-4 тыс. рублей в час_
- **Услуги тренера** — примерно _2-3 тыс. рублей в час_
- **Кроссовки для падела** — примерно _8-10 тыс. руб._ (можно играть в теннисных кроссовках)
- **Ракетка для начинающих** — около _15 тыс. руб._
- **Сумка для падела** — около _5-6 тыс. руб._  
  **Набор мячей** (четыре штуки) — около _1 тыс. руб._  
  **Итого**: плюс-минус _38 тыс. рублей_
