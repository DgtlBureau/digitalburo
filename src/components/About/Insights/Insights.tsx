    ...
    <div className='flex flex-col gap-[20px] tablet:gap-[40px] desktop:gap-[60px]'>
      <div className='desktop:px-[80px]'>
        <NextLinePreposition
          ...
          className='font-unbound text-[24px] text-text-dark font-bold uppercase leading-[1.1] tablet:text-[50px] tablet:leading-[1.3] desktop:text-[55px] desktop:leading-[1.1] desktop-light:text-[60px] desktop-hard:text-[70px]'
        />
      </div>
    </div>
  )
