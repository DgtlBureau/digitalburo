    ...
    >
      <div className={styles.contentWrapper}>
        <div className='flex justify-between'>
          <p className='font-unbound text-[18px] text-white font-bold uppercase leading-[1.1] tablet:text-[24px]'>
            {description}
          </p>
          <Link href={link}>
        ...
        <h2 className='z-10 font-unbound text-[45px] text-white font-bold uppercase leading-[1] tablet:text-[50px] desktop:text-[80px] desktop-hard:text-[100px]'>
          {title}
        </h2>
