    ...
    <div className="flex flex-col gap-[30px]">
      <div className="flex items-start justify-between">
        <div className="flex flex-col gap-[30px] z-20">
          <h2 className="font-unbound text-[32px] relative z-20 font-bold uppercase leading-[1] tablet:text-[38px] tablet:leading-[1.3] desktop:text-[50px] desktop:leading-[1.1]">
            Активные вакансии
          </h2>
          {withFilter && (
            <p className="hidden laptop-big:block font-proxima text-[20px] text-white max-w-[904px]">
      ...
      <div>
        {withFilter && (
          <div className="flex gap-[14px] z-30 relative">
