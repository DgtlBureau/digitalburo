...
const VALUES_ITEMS = [
  ...
  },
  {
    title: 'Забота',
    description:
      'Нам небезразлично, что происходит на проекте и с нашими клиентами. Мы всегда думаем о том, как сделать мир вокруг нас лучше. В Digital Buro мы поощряем инициативу.',
  },
];
export const Values = () => {
  return (
